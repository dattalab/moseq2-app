...
class ArenaMaskView(Viewer):
    ...
    def __init__(self, session_data: ArenaMaskData, **params):
        ...
        adv_extraction = pn.Column(
            ...
            pn.pane.Markdown("#### Tail filtering parameters", height=20, width=160),
            tail_filters,
            tail_filter_shape,
            tail_filter_size,
            pn.pane.Markdown("#### Pose filtering parameters", height=20, width=160),
            spatial_filter,
            temporal_filter,
            pn.pane.Markdown("#### Video parameters", height=20, width=140),
            chunk_overlap,
            frame_dtype,
            movie_dtype,
            pixel_format,
            compress,
            pn.pane.Markdown("#### Tracking model parameters", height=20, width=170),
            tracking_model_flag,
            tracking_model_mask_thresh,
            pn.pane.Markdown("#### Cable filtering parameters", height=20, width=170),
            cable_filters,
            cable_filter_shape,
            cable_filter_size,
            visible=False,
