...
def update_model_paths(desired_model, model_dict, progress_filepath):
    ...
    assert desired_model in model_dict, f'{desired_model} not found in model_dict. Make sure desired_model is one of the keys in model_dict. Possible keys: {" ".join(map(str, model_dict))}'
